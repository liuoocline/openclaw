...
const loadConfig = async () => {
	return (await import("./config-BXK2Ocdw.js").then((n) => n.t)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-BeAwmkZD.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		register: async (program) => {
			(await import("./gateway-cli-HfiEDkE9.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-Cf07dcGb.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-RWe5Od-m.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		register: async (program) => {
			(await import("./system-cli-DMHGGniL.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		register: async (program) => {
			(await import("./models-cli-Ae-kkmmy.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		register: async (program) => {
			(await import("./exec-approvals-cli-BJRDk2yt.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		register: async (program) => {
			(await import("./nodes-cli-XSHraxSx.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		register: async (program) => {
			(await import("./devices-cli-CAJmW_Qx.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		register: async (program) => {
			(await import("./node-cli-lL9eGL3h.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		register: async (program) => {
			(await import("./sandbox-cli-D-Gvw7cj.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		register: async (program) => {
			(await import("./tui-cli-i6M1gNxG.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		register: async (program) => {
			(await import("./cron-cli-BB2ULyzo.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		register: async (program) => {
			(await import("./dns-cli-BL7xa2xN.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		register: async (program) => {
			(await import("./docs-cli-Cgjnx1hg.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		register: async (program) => {
			(await import("./hooks-cli-oiBJrP5q.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		register: async (program) => {
			(await import("./webhooks-cli-vXQS17N6.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "pairing",
		...
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-DlwV_ri8.js");
			registerPluginCliCommands(program, await loadConfig());
			(await import("./pairing-cli-yalJICja.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		register: async (program) => {
			(await import("./plugins-cli-_stgFg4Z.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-DlwV_ri8.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-BNwbImdl.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		register: async (program) => {
			(await import("./directory-cli-BQnxobLJ.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		register: async (program) => {
			(await import("./security-cli-C3N2_FbU.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
		...
		register: async (program) => {
			(await import("./skills-cli-DoMmuufw.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		register: async (program) => {
			(await import("./update-cli-WvA_KswZ.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		register: async (program) => {
			(await import("./completion-cli-4D_q9YdQ.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
