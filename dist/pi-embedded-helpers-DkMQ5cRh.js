...
import { O as isTruthyEnvValue, k as parseBooleanValue } from "./model-selection-DlV6wnTr.js";
import { t as formatCliCommand } from "./command-format-CFzL448l.js";
import { A as resolveWhatsAppAccount, _ as normalizePluginsConfig, d as parseDurationMs, g as MANIFEST_KEY, h as LEGACY_MANIFEST_KEYS, i as writeConfigFile, o as parseByteSize, p as loadPluginManifestRegistry, t as loadConfig, v as resolveEnableState, y as resolveMemorySlotDecision } from "./config-CQt4vGxI.js";
import { C as DEFAULT_AI_SNAPSHOT_MAX_CHARS, D as DEFAULT_OPENCLAW_BROWSER_ENABLED, E as DEFAULT_OPENCLAW_BROWSER_COLOR, O as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, S as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, T as DEFAULT_BROWSER_EVALUATE_ENABLED, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, g as stopChromeExtensionRelayServer, h as ensureChromeExtensionRelayServer, i as launchOpenClawChrome, l as createTargetViaCdp, m as getHeadersWithAuth, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as isLoopbackHost, w as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, x as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH } from "./chrome-CQd_MVOA.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-dpUbQseI.js";
import { r as resolveSessionTranscriptPath, t as resolveDefaultSessionStorePath } from "./paths-uoGO2aiO.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-qEMUq5Mt.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-qEMUq5Mt.js")).closePlaywrightBrowserConnection();
		} catch {}
...
function formatAssistantErrorText(msg, opts) {
	...
	if (isJsonParseError(raw)) return "Tool call failed due to JSON format error. This may be caused by special characters in the content. Please try rephrasing your request or use simpler text.";
...
//#endregion
export { updateSessionStore as $, expandToolGroups as $t, isCloudCodeAssistFormatError as A, getChannelPlugin as An, getImageMetadata as At, parseImageDimensionError as B, resolveSlackAccount as Bn, resolvePinnedHostnameWithPolicy as Bt, BILLING_ERROR_USER_MESSAGE as C, isGifMedia as Cn, resolveConversationLabel as Ct, getApiErrorPayloadFingerprint as D, mediaKindFromMime as Dn, resolveBrowserConfig as Dt, formatRawAssistantErrorForUi as E, maxBytesForKind as En, registerBrowserRoutes as Et, isJsonParseError as F, listEnabledTelegramAccounts as Fn, saveMediaBuffer as Ft, resolveSandboxRuntimeStatus as G, resolveDiscordAccount as Gn, resolvePluginSkillDirs as Gt, sanitizeUserFacingText as H, resolveSlackBotToken as Hn, buildWorkspaceSkillSnapshot as Ht, isLikelyContextOverflowError as I, listTelegramAccountIds as In, SsrFBlockedError as It, loadSessionStore as J, resolveSandboxConfigForAgent as Jt, appendAssistantMessageToSessionTranscript as K, normalizeDiscordToken as Kn, applySkillEnvOverrides as Kt, isRateLimitAssistantError as L, resolveTelegramAccount as Ln, closeDispatcher as Lt, isContextOverflowError as M, normalizeChannelId as Mn, optimizeImageToPng as Mt, isFailoverAssistantError as N, isWhatsAppGroupJid as Nn, resizeToJpeg as Nt, isAuthAssistantError as O, listEnabledSignalAccounts as On, resolveProfile as Ot, isFailoverErrorMessage as P, normalizeWhatsAppTarget as Pn, getMediaDir as Pt, updateLastRoute as Q, expandPolicyWithPluginGroups as Qt, isRawApiErrorPayload as R, resolveTelegramToken as Rn, createPinnedDispatcher as Rt, isGoogleModelApi as S, isAudioFileName as Sn, resolveIMessageAccount as St, formatAssistantErrorText as T, MAX_IMAGE_BYTES$1 as Tn, createBrowserRouteContext as Tt, ensureSandboxWorkspaceForSession as U, normalizeChatType as Un, loadWorkspaceSkillEntries as Ut, parseImageSizeError as V, resolveSlackAppToken as Vn, buildWorkspaceSkillCommandSpecs as Vt, resolveSandboxContext as W, listEnabledDiscordAccounts as Wn, resolveSkillsPromptForRun as Wt, recordSessionMetaFromInbound as X, buildPluginToolGroups as Xt, readSessionUpdatedAt as Y, applyOwnerOnlyToolPolicy as Yt, saveSessionStore as Z, collectExplicitAllowlist as Zt, sanitizeSessionMessagesImages as _, GATEWAY_CLIENT_NAMES as _n, getChannelDock as _t, formatXHighModelHint as a, resolveBootstrapMaxChars as an, mergeDeliveryContext as at, downgradeOpenAIReasoningBlocks as b, getFileExtension as bn, resolveChannelGroupRequireMention as bt, normalizeReasoningLevel as c, isDeliverableMessageChannel as cn, resolveSessionKey as ct, normalizeVerboseLevel as d, listDeliverableMessageChannels as dn, resolveSessionResetPolicy as dt, normalizeToolName as en, updateSessionStoreEntry as et, resolveResponseUsageMode as f, normalizeMessageChannel as fn, resolveSessionResetType as ft, normalizeTextForComparison as g, GATEWAY_CLIENT_MODES as gn, deriveSessionMetaPatch as gt, isMessagingToolDuplicateNormalized as h, GATEWAY_CLIENT_IDS as hn, resolveMainSessionKey as ht, formatThinkingLevels as i, ensureSessionHeader$1 as in, deliveryContextKey as it, isCompactionFailureError as j, listChannelPlugins as jn, hasAlphaChannel as jt, isBillingAssistantError as k, resolveSignalAccount as kn, convertHeicToJpeg as kt, normalizeThinkLevel as l, isInternalMessageChannel as ln, evaluateSessionFreshness as lt, isMessagingToolDuplicate as m, resolveMessageChannel as mn, DEFAULT_RESET_TRIGGERS as mt, validateGeminiTurns as n, stripPluginOnlyAllowlist as nn, resolveCacheTtlMs as nt, listThinkingLevels as o, sanitizeGoogleTurnOrdering as on, normalizeDeliveryContext as ot, supportsXHighThinking as p, resolveGatewayMessageChannel as pn, resolveThreadFlag as pt, resolveMirroredTranscriptText as q, applySkillEnvOverridesFromSnapshot as qt, pickFallbackThinkingLevel as r, buildBootstrapContextFiles as rn, deliveryContextFromSession as rt, normalizeElevatedLevel as s, INTERNAL_MESSAGE_CHANNEL as sn, normalizeSessionDeliveryFields as st, validateAnthropicTurns as t, resolveToolProfilePolicy as tn, isCacheEnabled as tt, normalizeUsageDisplay as u, isMarkdownCapableMessageChannel as un, resolveChannelResetConfig as ut, sanitizeImageBlocks as v, detectMime as vn, listChannelDocks as vt, classifyFailoverReason as w, kindFromMime as wn, resolveGroupSessionKey as wt, isAntigravityClaude as x, imageMimeFromFormat as xn, resolveChannelGroupToolsPolicy as xt, sanitizeToolResultImages as y, extensionForMime as yn, resolveChannelGroupPolicy as yt, isTimeoutErrorMessage as z, listBindings as zn, resolvePinnedHostname as zt };