...
const loadConfig = async () => {
	return (await import("./config-fCnPoWjU.js").then((n) => n.t)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-DKJRTfwB.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		register: async (program) => {
			(await import("./gateway-cli-Ci1apTdi.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-BrkxGLv5.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-Cm7AiarR.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		register: async (program) => {
			(await import("./system-cli-9fQ1uLiz.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		register: async (program) => {
			(await import("./models-cli-_1qzXVSy.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		register: async (program) => {
			(await import("./exec-approvals-cli-DPHItoxG.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		register: async (program) => {
			(await import("./nodes-cli-CVHzcQo2.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		register: async (program) => {
			(await import("./devices-cli-IxmPLIk8.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		register: async (program) => {
			(await import("./node-cli-BMUfVCSq.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		register: async (program) => {
			(await import("./sandbox-cli-C6_iNuqO.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		register: async (program) => {
			(await import("./tui-cli-C56hhn1h.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		register: async (program) => {
			(await import("./cron-cli-CB6CufAb.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		register: async (program) => {
			(await import("./dns-cli-DgVO0Pkw.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		register: async (program) => {
			(await import("./docs-cli-DZULc91f.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		register: async (program) => {
			(await import("./hooks-cli-6bPcuksb.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		register: async (program) => {
			(await import("./webhooks-cli-DUUa8gVY.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "pairing",
		...
		register: async (program) => {
			...
			(await import("./pairing-cli-BKJHBxwT.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		register: async (program) => {
			(await import("./plugins-cli-Bem6pRbt.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-BwiWvikX.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-ICtHEdM1.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		register: async (program) => {
			(await import("./directory-cli-Caq-OYk8.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		register: async (program) => {
			(await import("./security-cli-CTTD1vms.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
		...
		register: async (program) => {
			(await import("./skills-cli-DUncybht.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		register: async (program) => {
			(await import("./update-cli-DOxMeVbY.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		register: async (program) => {
			(await import("./completion-cli-CiSGNfMr.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
