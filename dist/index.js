...
import { Ct as formatControlUiSshHint, D as runMessageAction, Et as moveToTrash, Ft as waitForGatewayReachable, I as CHANNEL_MESSAGE_ACTION_NAMES, Mt as resolveControlUiLinks, Ot as openUrl, P as formatTargetDisplay, St as ensureWorkspaceAndSessions, Tt as handleReset, Wr as applyTemplate, an as registerMemoryCli, at as CHANNEL_TARGETS_DESCRIPTION, br as lookupContextTokens, ht as resolveCommitHash, jt as randomToken, kr as installUnhandledRejectionHandler, on as runMemoryStatus, ot as CHANNEL_TARGET_DESCRIPTION, sn as monitorWebChannel, t as getReplyFromConfig, un as waitForever, vt as DEFAULT_WORKSPACE, xt as detectBrowserOpenSupport, yt as applyWizardMetadata } from "./reply-BbfDy9zd.js";
...
import { t as createDefaultDeps } from "./deps-IZgOgUX9.js";
...
import { a as buildAgentSummaries, c as loadAgentIdentity, f as parseIdentityMarkdown, i as applyAgentConfig, l as pruneAgentConfig, n as statusCommand, o as findAgentEntryIndex, s as listAgentEntries, t as runOnboardingWizard, u as identityHasValues } from "./onboarding-Csg2KvCt.js";
...
import { l as healthCommand } from "./health-format-CGSk5eCw.js";
import "./update-runner-Bm3_34Ub.js";
...
import { c as registerSubCliCommands, d as getPositiveIntFlagValue, f as getVerboseFlag, l as getCommandPath, m as hasHelpOrVersion, p as hasFlag, u as getFlagValue } from "./completion-cli-CUFKuuN3.js";
...
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-CJtJ-vou.js";
import { i as hasExplicitOptions, n as resolveCliChannelOptions, r as ensurePluginRegistryLoaded } from "./channel-options-ppqksgCl.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CRzoyyXS.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-B3EPVU7P.js";
...
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-ClmYWS1Y.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-B3EPVU7P.js").then((n) => n.t);
