...
const TOGETHER_DEFAULT_MODEL_REF = "together/zai-org/GLM-4.7";
...
//#endregion
export { setMinimaxApiKey as $, applyQianfanProviderConfig as A, applyXaiProviderConfig as B, applyMoonshotConfig as C, applyOpenrouterConfig as D, applyMoonshotProviderConfigCn as E, applyVeniceConfig as F, TOGETHER_DEFAULT_MODEL_REF as G, applyXiaomiProviderConfig as H, applyVeniceProviderConfig as I, ZAI_DEFAULT_MODEL_REF as J, VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF as K, applyVercelAiGatewayConfig as L, applySyntheticProviderConfig as M, applyTogetherConfig as N, applyOpenrouterProviderConfig as O, applyTogetherProviderConfig as P, setKimiCodingApiKey as Q, applyVercelAiGatewayProviderConfig as R, applyKimiCodeProviderConfig as S, applyMoonshotProviderConfig as T, applyZaiConfig as U, applyXiaomiConfig as V, OPENROUTER_DEFAULT_MODEL_REF as W, setCloudflareAiGatewayConfig as X, setAnthropicApiKey as Y, setGeminiApiKey as Z, applyMinimaxProviderConfig as _, validateAnthropicSetupToken as _t, normalizeAlias as a, setTogetherApiKey as at, applyCloudflareAiGatewayProviderConfig as b, updateConfig as c, setXaiApiKey as ct, resolvePluginProviders as d, writeOAuthCredentials as dt, setMoonshotApiKey as et, applyOpencodeZenConfig as f, KIMI_CODING_MODEL_REF as ft, applyMinimaxConfig as g, buildTokenProfileId as gt, applyMinimaxApiProviderConfig as h, XAI_DEFAULT_MODEL_REF as ht, formatTokenK as i, setSyntheticApiKey as it, applySyntheticConfig as j, applyQianfanConfig as k, createVpsAwareOAuthHandlers as l, setXiaomiApiKey as lt, applyMinimaxApiConfig as m, QIANFAN_DEFAULT_MODEL_REF as mt, ensureFlagCompatibility as n, setOpenrouterApiKey as nt, resolveKnownAgentId as o, setVeniceApiKey as ot, applyOpencodeZenProviderConfig as p, MOONSHOT_DEFAULT_MODEL_REF as pt, XIAOMI_DEFAULT_MODEL_REF as q, formatMs as r, setQianfanApiKey as rt, resolveModelTarget as s, setVercelAiGatewayApiKey as st, githubCopilotLoginCommand as t, setOpencodeZenApiKey as tt, isRemoteEnvironment as u, setZaiApiKey as ut, applyAuthProfileConfig as v, applyMoonshotConfigCn as w, applyKimiCodeConfig as x, applyCloudflareAiGatewayConfig as y, applyXaiConfig as z };