...
import { D as DEFAULT_OPENCLAW_BROWSER_ENABLED, E as DEFAULT_OPENCLAW_BROWSER_COLOR, O as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, T as DEFAULT_BROWSER_EVALUATE_ENABLED, _ as appendCdpPath, a as resolveOpenClawUserDataDir, b as stopChromeExtensionRelayServer, h as normalizeCdpWsUrl, i as launchOpenClawChrome, n as isChromeCdpReady, o as stopOpenClawChrome, p as createTargetViaCdp, r as isChromeReachable, v as getHeadersWithAuth, w as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, y as ensureChromeExtensionRelayServer } from "./chrome-B2UjqY-9.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-1NN0FrJb.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-1NN0FrJb.js")).closePlaywrightBrowserConnection();
		} catch {}
