...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-ByPfQMd2.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-ByPfQMd2.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { updateSessionStoreEntry as $, expandPolicyWithPluginGroups as $t, isCloudCodeAssistFormatError as A, listEnabledSignalAccounts as An, convertHeicToJpeg as At, parseImageDimensionError as B, resolveTelegramToken as Bn, resolvePinnedHostname as Bt, BILLING_ERROR_USER_MESSAGE as C, imageMimeFromFormat as Cn, resolveIMessageAccount as Ct, getApiErrorPayloadFingerprint as D, MAX_IMAGE_BYTES$1 as Dn, registerBrowserRoutes as Dt, formatRawAssistantErrorForUi as E, kindFromMime as En, createBrowserRouteContext as Et, isJsonParseError as F, isWhatsAppGroupJid as Fn, getMediaDir as Ft, resolveSandboxRuntimeStatus as G, normalizeChatType as Gn, resolveSkillsPromptForRun as Gt, sanitizeUserFacingText as H, resolveSlackAccount as Hn, buildWorkspaceSkillCommandSpecs as Ht, isLikelyContextOverflowError as I, normalizeWhatsAppTarget as In, saveMediaBuffer as It, loadSessionStore as J, normalizeDiscordToken as Jn, applySkillEnvOverridesFromSnapshot as Jt, appendAssistantMessageToSessionTranscript as K, listEnabledDiscordAccounts as Kn, resolvePluginSkillDirs as Kt, isRateLimitAssistantError as L, listEnabledTelegramAccounts as Ln, SsrFBlockedError as Lt, isContextOverflowError as M, getChannelPlugin as Mn, hasAlphaChannel as Mt, isFailoverAssistantError as N, listChannelPlugins as Nn, optimizeImageToPng as Nt, isAuthAssistantError as O, maxBytesForKind as On, resolveBrowserConfig as Ot, isFailoverErrorMessage as P, normalizeChannelId as Pn, resizeToJpeg as Pt, updateSessionStore as Q, collectExplicitAllowlist as Qt, isRawApiErrorPayload as R, listTelegramAccountIds as Rn, closeDispatcher as Rt, isGoogleModelApi as S, getFileExtension as Sn, resolveChannelGroupToolsPolicy as St, formatAssistantErrorText as T, isGifMedia as Tn, resolveGroupSessionKey as Tt, ensureSandboxWorkspaceForSession as U, resolveSlackAppToken as Un, buildWorkspaceSkillSnapshot as Ut, parseImageSizeError as V, listBindings as Vn, resolvePinnedHostnameWithPolicy as Vt, resolveSandboxContext as W, resolveSlackBotToken as Wn, loadWorkspaceSkillEntries as Wt, recordSessionMetaFromInbound as X, applyOwnerOnlyToolPolicy as Xt, readSessionUpdatedAt as Y, resolveSandboxConfigForAgent as Yt, updateLastRoute as Z, buildPluginToolGroups as Zt, sanitizeSessionMessagesImages as _, GATEWAY_CLIENT_IDS as _n, deriveSessionMetaPatch as _t, formatXHighModelHint as a, ensureSessionHeader$1 as an, normalizeDeliveryContext as at, downgradeOpenAIReasoningBlocks as b, detectMime as bn, resolveChannelGroupPolicy as bt, normalizeReasoningLevel as c, INTERNAL_MESSAGE_CHANNEL as cn, resolveSessionKey as ct, normalizeVerboseLevel as d, isInternalMessageChannel as dn, resolveSessionResetPolicy as dt, expandToolGroups as en, isCacheEnabled as et, resolveResponseUsageMode as f, isMarkdownCapableMessageChannel as fn, resolveSessionResetType as ft, normalizeTextForComparison as g, resolveMessageChannel as gn, resolveMainSessionKey as gt, isMessagingToolDuplicateNormalized as h, resolveGatewayMessageChannel as hn, resolveExplicitAgentSessionKey as ht, formatThinkingLevels as i, buildBootstrapContextFiles as in, mergeDeliveryContext as it, isCompactionFailureError as j, resolveSignalAccount as jn, getImageMetadata as jt, isBillingAssistantError as k, mediaKindFromMime as kn, resolveProfile as kt, normalizeThinkLevel as l, isDeliverableMessageChannel as ln, evaluateSessionFreshness as lt, isMessagingToolDuplicate as m, normalizeMessageChannel as mn, DEFAULT_RESET_TRIGGERS as mt, validateGeminiTurns as n, resolveToolProfilePolicy as nn, deliveryContextFromSession as nt, listThinkingLevels as o, resolveBootstrapMaxChars as on, normalizeSessionDeliveryFields as ot, supportsXHighThinking as p, listDeliverableMessageChannels as pn, resolveThreadFlag as pt, resolveMirroredTranscriptText as q, resolveDiscordAccount as qn, applySkillEnvOverrides as qt, pickFallbackThinkingLevel as r, stripPluginOnlyAllowlist as rn, deliveryContextKey as rt, normalizeElevatedLevel as s, sanitizeGoogleTurnOrdering as sn, normalizeAccountId as st, validateAnthropicTurns as t, normalizeToolName as tn, resolveCacheTtlMs as tt, normalizeUsageDisplay as u, isGatewayMessageChannel as un, resolveChannelResetConfig as ut, sanitizeImageBlocks as v, GATEWAY_CLIENT_MODES as vn, getChannelDock as vt, classifyFailoverReason as w, isAudioFileName as wn, resolveConversationLabel as wt, isAntigravityClaude as x, extensionForMime as xn, resolveChannelGroupRequireMention as xt, sanitizeToolResultImages as y, GATEWAY_CLIENT_NAMES as yn, listChannelDocks as yt, isTimeoutErrorMessage as z, resolveTelegramAccount as zn, createPinnedDispatcher as zt };