...
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-CCgjNlSQ.js";
import { c as resolveDefaultAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-tDG9mXT6.js";
import { g as parseDurationMs, i as loadConfig } from "./config-BYXIxSeu.js";
...
import { f as resolvePreferredAccountId, n as listChannelPlugins, t as getChannelPlugin, u as buildChannelAccountBindings } from "./plugins-w06Vb-by.js";
import { A as resolveHeartbeatVisibility, Cr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Dr as stripHeartbeatToken, Er as resolveHeartbeatPrompt$1, Mr as resolveUserTimezone, P as resolveIndicatorType, Rr as resolveEffectiveMessagesConfig, Sn as resolveHeartbeatSenderContext, Tr as isHeartbeatContentEffectivelyEmpty, V as getReplyFromConfig, _r as getQueueSize, er as peekSystemEvents, j as emitHeartbeatEvent, nr as setHeartbeatWakeHandler, tr as requestHeartbeatNow, wr as DEFAULT_HEARTBEAT_EVERY, xn as resolveHeartbeatDeliveryTarget, yr as CommandLane } from "./loader-BvVnSZJi.js";
...
import { A as HEARTBEAT_TOKEN, t as deliverOutboundPayloads } from "./deliver-BNJsqxcs.js";
import { N as canonicalizeMainSessionAlias, P as resolveAgentMainSessionKey, d as loadSessionStore, g as updateSessionStore, m as saveSessionStore } from "./sandbox-BETrMoPm.js";
...
async function runHeartbeatOnce(opts) {
	...
	try {
		if (isHeartbeatContentEffectivelyEmpty(await fsPromises.readFile(heartbeatFilePath, "utf-8")) && !isExecEventReason && !isCronEventReason) {
			emitHeartbeatEvent({
				status: "skipped",
