...
import { Ct as DEFAULT_CONTEXT_TOKENS, N as resolveConfiguredModelRef, Tt as DEFAULT_PROVIDER, _ as ensureAuthProfileStore, wt as DEFAULT_MODEL } from "./auth-profiles-CLN7qdwL.js";
...
import { c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-tDG9mXT6.js";
import { M as VERSION, c as writeConfigFile, i as loadConfig, o as readConfigFileSnapshot } from "./config-BYXIxSeu.js";
import { d as formatPortDiagnostics, l as inspectPortUsage } from "./chrome-D81-KU5p.js";
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-DU6DgqVy.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BVsSPFqZ.js";
import { n as listChannelPlugins } from "./plugins-w06Vb-by.js";
import { Fr as getMemorySearchManager, G as buildChannelSummary, J as getRemoteSkillEligibility, Qt as formatUsageReportLines, Rn as readRestartSentinel, Zt as loadProviderUsageSummary, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, er as peekSystemEvents, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, jt as sha256HexPrefix, l as formatControlUiSshHint, m as openUrl, mn as lookupContextTokens, p as normalizeGatewayTokenInput, s as detectBrowserOpenSupport, tn as listAgentsForGateway, v as resolveControlUiLinks, w as normalizeControlUiBasePath, x as waitForGatewayReachable, zn as summarizeRestartSentinel } from "./loader-BvVnSZJi.js";
...
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-BETrMoPm.js";
...
import { t as collectChannelStatusIssues } from "./channels-status-issues-BH0EGtoK.js";
import { r as installCompletion } from "./completion-cli-2ItpXD-U.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-PO6b9aOs.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-D6rtu1p1.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-C4ZgfK1Q.js";
import { o as readLastGatewayErrorLine } from "./service-audit-De5E3f4l.js";
import { t as renderTable } from "./table-cCoGqLsk.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-DqnrLraG.js";
import { c as promptDefaultModel, d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, i as promptCustomApiConfig, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as resolvePreferredProviderForAuthChoice } from "./onboard-skills-D-4Qg6SU.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-DAG6GYZ5.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, c as formatUpdateOneLiner, d as checkShellCompletionStatus, h as compareSemverStrings, l as getUpdateCheckResult, m as checkUpdateStatus, p as ensureCompletionCacheExists, s as formatUpdateAvailableHint, u as resolveUpdateAvailability, x as formatUpdateChannelLabel } from "./update-runner-DBJfu6OC.js";
import { n as logConfigUpdated } from "./logging-DuK6YXuK.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-Cms3vhAm.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-D6ZWsOj-.js";
import { t as runTui } from "./tui-Cprb4KEl.js";
import { t as resolveNodeService } from "./node-service-BIxei92R.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-eO-4-yqy.js").then((n) => n.r);
