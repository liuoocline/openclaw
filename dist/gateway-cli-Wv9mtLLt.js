...
import { C as shortenHomePath, D as truncateUtf16Safe, b as resolveUserPath, c as ensureDir, d as isPlainObject, r as clamp, t as CONFIG_DIR } from "./utils-BTaR--Ln.js";
import { G as normalizeVerboseLevel, H as normalizeReasoningLevel, L as formatThinkingLevels, R as formatXHighModelHint, U as normalizeThinkLevel, V as normalizeElevatedLevel, W as normalizeUsageDisplay, q as supportsXHighThinking } from "./pi-embedded-helpers-3VNdf0Et.js";
import { $ as inferLegacyName, $n as isTtsEnabled, $t as getSkillsSnapshotVersion, An as clearAgentRunContext, Ar as registerUnhandledRejectionHandler, B as consumeGatewaySigusr1RestartAuthorization, Bn as resolveMemoryBackendConfig, Br as DEFAULT_INPUT_TIMEOUT_MS, Bt as getRemoteSkillEligibility, C as readSessionMessages, Cn as createReplyDispatcher, Cr as applyVerboseOverride, Dn as initSubagentRegistry, E as stripEnvelopeFromMessages, En as stopSubagentsForRequester, Er as isSystemEventContextChanged, F as resetDirectoryCache, Fr as DEFAULT_INPUT_IMAGE_MIMES, G as formatDoctorNonInteractiveHint, Gn as resolveUserTimezone, Gr as resolveAgentTimeoutMs, Gt as setSkillsRemoteRegistry, H as scheduleGatewaySigusr1Restart, Hr as extractImageContentFromSource, Ht as recordRemoteNodeInfo, In as normalizePollInput, Ir as DEFAULT_INPUT_MAX_REDIRECTS, It as CONTROL_UI_AVATAR_PREFIX, J as summarizeRestartSentinel, Jn as registerInternalHook, Jt as rejectNodePairing, K as formatRestartSentinelMessage, Kn as clearInternalHooks, Kt as approveNodePairing, L as runWithModelFallback, Lr as DEFAULT_INPUT_PDF_MAX_PAGES, Lt as buildControlUiAvatarUrl, M as resolveOutboundTarget, Mn as getAgentRunContext, Mr as DEFAULT_INPUT_FILE_MAX_CHARS, N as resolveSessionDeliveryTarget, Nn as onAgentEvent, Nr as DEFAULT_INPUT_FILE_MIMES, O as ensureOutboundSessionEntry, On as runSubagentAnnounceFlow, Or as loadModelCatalog, Pn as registerAgentRunContext, Pr as DEFAULT_INPUT_IMAGE_MAX_BYTES, Q as normalizeCronJobPatch, Qn as getTtsProvider, Qt as verifyNodeToken, Rr as DEFAULT_INPUT_PDF_MAX_PIXELS, Rt as normalizeControlUiBasePath, S as capArrayByJsonBytes, Sn as dispatchInboundMessage, Sr as applyModelOverrideToSessionEntry, T as resolveSessionTranscriptCandidates, Tn as isAbortTrigger, Tr as enqueueSystemEvent, Tt as handleReset, U as setGatewaySigusr1RestartPolicy, Un as formatUserTime, Ur as normalizeMimeList, Ut as refreshRemoteBinsForConnectedNodes, V as isGatewaySigusr1RestartExternallyAllowed, Vn as resolveAgentIdentity, Vr as extractFileContentFromSource, Vt as primeRemoteSkillsCache, W as consumeRestartSentinel, Wn as resolveUserTimeFormat, Wt as refreshRemoteNodeBins, X as writeRestartSentinel, Xn as OPENAI_TTS_MODELS, Xt as requestNodePairing, Yn as triggerInternalHook, Yt as renamePairedNode, Z as normalizeCronJobCreate, Zn as OPENAI_TTS_VOICES, Zt as updatePairedNodeMetadata, _ as loadCombinedSessionStoreForGateway, ar as resolveTtsProviderOrder, b as resolveSessionModelRef, br as lookupContextTokens, c as clearSessionQueues, cn as createReplyPrefixOptions, cr as textToSpeech, d as waitForEmbeddedPiRunEnd, dn as buildHistoryContextFromEntries, dr as CommandLane, dt as loadProviderUsageSummary, en as registerSkillsChangeListener, er as isTtsProviderConfigured, et as normalizeOptionalAgentId, fn as resolveHeartbeatVisibility, fr as startDiagnosticHeartbeat, g as listSessionsFromStore, gt as handleSlackHttpRequest, h as listAgentsForGateway, hn as onHeartbeatEvent, hr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, i as runCliAgent, in as isExternalHookSession, ir as resolveTtsPrefsPath, it as migrateLegacyCronPayload, jn as emitAgentEvent, jr as DEFAULT_INPUT_FILE_MAX_BYTES, k as resolveOutboundSessionRoute, l as runEmbeddedPiAgent, ln as normalizeGroupActivation, lt as getPluginToolMeta, m as resolveAnnounceTargetFromKey, mn as getLastHeartbeatEvent, mr as isDiagnosticsEnabled, n as getCliSessionId, nn as detectSuspiciousPatterns, nr as resolveTtsAutoMode, nt as normalizePayloadToSystemText, o as normalizeSendPolicy, or as setTtsEnabled, p as createOpenClawTools, pr as stopDiagnosticHeartbeat, qn as createInternalHookEvent, qt as listNodePairing, r as setCliSessionId, rn as getHookType, rr as resolveTtsConfig, rt as normalizeRequiredName, s as resolveSendPolicy, sr as setTtsProvider, st as requestHeartbeatNow, tn as buildSafeExternalPrompt, tr as resolveTtsApiKey, tt as normalizeOptionalText, u as abortEmbeddedPiRun, ur as setCommandLaneConcurrency, ut as loadOpenClawPlugins, v as loadSessionEntry, w as readSessionPreviewItemsFromTranscript, wn as formatZonedTimestamp, wr as parseVerboseOverride, x as archiveFileOnDisk, y as resolveGatewaySessionStoreTarget, yn as getChannelActivity, yr as stripHeartbeatToken, z as authorizeGatewaySigusr1Restart, zn as getMemorySearchManager, zr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, zt as resolveAssistantAvatarUrl } from "./reply-DoLaxYcL.js";
...
import { A as resolveAgentMaxConcurrent, E as applyLegacyMigrations, M as VERSION, a as parseConfigJson5, c as writeConfigFile, g as parseDurationMs, i as loadConfig, j as resolveSubagentMaxConcurrent, l as validateConfigObjectWithPlugins, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as resolveConfigSnapshotHash, u as OpenClawSchema } from "./config-Bj2eDa02.js";
import { s as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DyMRD3rY.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-CQw3z3Nw.js";
...
import { d as inspectPortUsage, l as ensurePortAvailable, p as formatPortDiagnostics } from "./chrome-COabMr6f.js";
import { d as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-_eKGrw9z.js";
import { c as saveMediaBuffer, l as detectMime } from "./routes-BrWrBk2R.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-B0eT3jVv.js";
import { n as movePathToTrash } from "./server-context-39mkstUs.js";
...
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-CHRYQtAM.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-gG96mWwA.js";
...
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-BDgF-FZ0.js";
import { t as parseAbsoluteTimeMs } from "./parse-DqAvJRIf.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-DPV9hvY8.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-BdUcXZXg.js";
...
import "./daemon-runtime-DwQFvDXZ.js";
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, i as applyAgentConfig, l as pruneAgentConfig, o as findAgentEntryIndex, p as forceFreePortAndWait, r as getStatusSummary, s as listAgentEntries, t as runOnboardingWizard } from "./onboarding-CaVSPyFn.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-C89IG08W.js";
import "./logging-CNq0UUgf.js";
import "./note-DVO1KLaW.js";
import { t as WizardCancelledError } from "./prompts--d-6l5Ln.js";
import { i as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-Bhy-hbjg.js";
import "./github-copilot-auth-Btgl1BvA.js";
import "./onboard-channels-BAkaOfch.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-D5ye7QnB.js";
import "./archive-CXhvR9nU.js";
import "./skill-scanner-DrVEHfC6.js";
import "./installs-CXGV291R.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-DmCbnmNy.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-Ccxp0lnp.js";
import { i as resolveGatewayAuth, n as authorizeGatewayConnect, r as isLocalDirectRequest, t as assertGatewayAuthConfigured } from "./auth-DkjJ3pm-.js";
import { i as probeGateway } from "./audit-Dn2cBl2x.js";
import "./table-Bb9gAVIp.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Ck0CCFZG.js";
import "./service-DOlJdIqe.js";
import "./systemd-Pa7LURHB.js";
import "./service-audit-VDRrWefh.js";
import "./node-service-DQ-tiSie.js";
import "./channels-status-issues-BN1ICfdy.js";
import "./completion-cli-DCZ3lUVz.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-0dGVpwVh.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BgYasW6m.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-lHWrY64E.js";
import "./tui-Ci5pYrj5.js";
import { t as buildChannelAccountSnapshot } from "./status-Cv36yYdi.js";
import "./shared-C92wo-6f.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-CqJYLh29.js";
...
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-C6vm_XMA.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-CAM1vbUS.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-1cqhFuZ_.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-BDgF-FZ0.js").then((n) => n.t);
