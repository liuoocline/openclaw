...
import { g as pathExists } from "./utils-BTaR--Ln.js";
...
const loadConfig = async () => {
	return (await import("./config-Bj2eDa02.js").then((n) => n.t)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-MZ3h1E1n.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		register: async (program) => {
			(await import("./gateway-cli-BLB-OFcS.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-BAY4ybFe.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-BWmtAsjp.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		register: async (program) => {
			(await import("./system-cli-Gq8OWHFg.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		register: async (program) => {
			(await import("./models-cli-B287KTq0.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		register: async (program) => {
			(await import("./exec-approvals-cli-EASbqFd-.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		register: async (program) => {
			(await import("./nodes-cli-BX6oWnLC.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		register: async (program) => {
			(await import("./devices-cli-N559801X.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		register: async (program) => {
			(await import("./node-cli-DY4lzhDA.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		register: async (program) => {
			(await import("./sandbox-cli-C_wK-KAE.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		register: async (program) => {
			(await import("./tui-cli-4VKrKO20.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		register: async (program) => {
			(await import("./cron-cli-Db6fardJ.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		register: async (program) => {
			(await import("./dns-cli-BTNZkWHs.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		register: async (program) => {
			(await import("./docs-cli-9Xan7C6D.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		register: async (program) => {
			(await import("./hooks-cli-CfDCO5xD.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		register: async (program) => {
			(await import("./webhooks-cli-Db3zyJaw.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "pairing",
		...
		register: async (program) => {
			const { registerPluginCliCommands } = await import("./cli-STjSlyrz.js");
			registerPluginCliCommands(program, await loadConfig());
			(await import("./pairing-cli-DJHjPBwu.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		register: async (program) => {
			(await import("./plugins-cli-ZVVUf2VF.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-STjSlyrz.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-CJHGzuOf.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		register: async (program) => {
			(await import("./directory-cli-ClrdmQL-.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		register: async (program) => {
			(await import("./security-cli-DRpGF2Yc.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
		...
		register: async (program) => {
			(await import("./skills-cli-DqvLjooh.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		register: async (program) => {
			(await import("./update-cli-DLQdbq0i.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
