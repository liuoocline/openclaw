...
import { n as setupChannels } from "./onboard-channels-BeFbtkXw.js";
...
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-D_8Ncr02.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-DUoNILn5.js";
...
import { t as createDefaultDeps } from "./deps-BMLFefF0.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-Ddtuz65D.js").then((n) => n.t);
