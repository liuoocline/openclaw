...
import { c as resolveDefaultAgentId, f as DEFAULT_AGENT_WORKSPACE_DIR, h as DEFAULT_IDENTITY_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, w as resolveDefaultAgentWorkspaceDir, x as ensureAgentWorkspace } from "./agent-scope-tDG9mXT6.js";
import { c as writeConfigFile, g as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-BYXIxSeu.js";
import { n as movePathToTrash } from "./server-context-B_EbOpJr.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-BVsSPFqZ.js";
...
import { n as setupChannels } from "./onboard-channels-CnkIwT7I.js";
...
import { d as loadSessionStore } from "./sandbox-BETrMoPm.js";
import { n as formatTimeAgo } from "./format-relative-79_Y1n2Y.js";
import { n as runCommandWithRuntime } from "./cli-utils-PlLcDZlM.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-t0-zcsKq.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-DR1Sp5Rn.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CQI-5xS9.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-KFfnfnoN.js";
import { t as createDefaultDeps } from "./deps-DK7844Cb.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-PO6b9aOs.js";
import { t as resolveGatewayService } from "./service-D6rtu1p1.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-C4ZgfK1Q.js";
import { t as renderTable } from "./table-cCoGqLsk.js";
import { d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, h as applyGoogleGeminiModelDefault, m as upsertSharedEnvVar, p as applyOpenAIConfig } from "./onboard-skills-D-4Qg6SU.js";
import { l as healthCommand } from "./health-format-DAG6GYZ5.js";
import { $ as setMinimaxApiKey, C as applyMoonshotConfig, D as applyOpenrouterConfig, F as applyVeniceConfig, L as applyVercelAiGatewayConfig, N as applyTogetherConfig, Q as setKimiCodingApiKey, U as applyZaiConfig, V as applyXiaomiConfig, X as setCloudflareAiGatewayConfig, Y as setAnthropicApiKey, Z as setGeminiApiKey, _t as validateAnthropicSetupToken, at as setTogetherApiKey, ct as setXaiApiKey, et as setMoonshotApiKey, f as applyOpencodeZenConfig, g as applyMinimaxConfig, gt as buildTokenProfileId, it as setSyntheticApiKey, j as applySyntheticConfig, k as applyQianfanConfig, lt as setXiaomiApiKey, m as applyMinimaxApiConfig, nt as setOpenrouterApiKey, ot as setVeniceApiKey, rt as setQianfanApiKey, st as setVercelAiGatewayApiKey, tt as setOpencodeZenApiKey, ut as setZaiApiKey, v as applyAuthProfileConfig, w as applyMoonshotConfigCn, x as applyKimiCodeConfig, y as applyCloudflareAiGatewayConfig, z as applyXaiConfig } from "./github-copilot-auth-zMce9EDV.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-DuK6YXuK.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-D0ik2mPc.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-C84IgDM9.js";
import { t as formatHelpExamples } from "./help-format-CUnac_bT.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-Daks_tts.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-eO-4-yqy.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-DgO4lD9v.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-Daks_tts.js").then((n) => n.t);
