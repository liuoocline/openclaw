...
const loadConfig = async () => {
	return (await import("./config-BYXIxSeu.js").then((n) => n.t)).loadConfig();
};
const entries = [
	{
		name: "acp",
		...
		register: async (program) => {
			(await import("./acp-cli-0mt4hvTA.js")).registerAcpCli(program);
		}
	},
	{
		name: "gateway",
		...
		register: async (program) => {
			(await import("./gateway-cli-CwNTvB8h.js")).registerGatewayCli(program);
		}
	},
	{
		name: "daemon",
		...
		register: async (program) => {
			(await import("./daemon-cli-RHdS_z1Q.js").then((n) => n.t)).registerDaemonCli(program);
		}
	},
	{
		name: "logs",
		...
		register: async (program) => {
			(await import("./logs-cli-D0uP8Kxk.js")).registerLogsCli(program);
		}
	},
	{
		name: "system",
		...
		register: async (program) => {
			(await import("./system-cli-tHIa59Gi.js")).registerSystemCli(program);
		}
	},
	{
		name: "models",
		...
		register: async (program) => {
			(await import("./models-cli-DcIVHsEt.js")).registerModelsCli(program);
		}
	},
	{
		name: "approvals",
		...
		register: async (program) => {
			(await import("./exec-approvals-cli-BLD0kyCH.js")).registerExecApprovalsCli(program);
		}
	},
	{
		name: "nodes",
		...
		register: async (program) => {
			(await import("./nodes-cli-BEtJ70h-.js")).registerNodesCli(program);
		}
	},
	{
		name: "devices",
		...
		register: async (program) => {
			(await import("./devices-cli-8ikA_8sy.js")).registerDevicesCli(program);
		}
	},
	{
		name: "node",
		...
		register: async (program) => {
			(await import("./node-cli-BQUZ_nKk.js")).registerNodeCli(program);
		}
	},
	{
		name: "sandbox",
		...
		register: async (program) => {
			(await import("./sandbox-cli-B7m1NsUR.js")).registerSandboxCli(program);
		}
	},
	{
		name: "tui",
		...
		register: async (program) => {
			(await import("./tui-cli-CN1w-ooj.js")).registerTuiCli(program);
		}
	},
	{
		name: "cron",
		...
		register: async (program) => {
			(await import("./cron-cli-Be0gMkxV.js")).registerCronCli(program);
		}
	},
	{
		name: "dns",
		...
		register: async (program) => {
			(await import("./dns-cli-lXIkqwCv.js")).registerDnsCli(program);
		}
	},
	{
		name: "docs",
		...
		register: async (program) => {
			(await import("./docs-cli-DXpJhkTU.js")).registerDocsCli(program);
		}
	},
	{
		name: "hooks",
		...
		register: async (program) => {
			(await import("./hooks-cli-CP_Lr35g.js")).registerHooksCli(program);
		}
	},
	{
		name: "webhooks",
		...
		register: async (program) => {
			(await import("./webhooks-cli-DhqGuN8W.js")).registerWebhooksCli(program);
		}
	},
	{
		name: "pairing",
		...
		register: async (program) => {
			...
			(await import("./pairing-cli-DyqL_FaW.js")).registerPairingCli(program);
		}
	},
	{
		name: "plugins",
		...
		register: async (program) => {
			(await import("./plugins-cli-ClIVvBrI.js")).registerPluginsCli(program);
			const { registerPluginCliCommands } = await import("./cli-BtR1sRnP.js");
			registerPluginCliCommands(program, await loadConfig());
		}
	},
	{
		...
		register: async (program) => {
			(await import("./channels-cli-DNZ5bm5f.js")).registerChannelsCli(program);
		}
	},
	{
		name: "directory",
		...
		register: async (program) => {
			(await import("./directory-cli-DuczlnJZ.js")).registerDirectoryCli(program);
		}
	},
	{
		name: "security",
		...
		register: async (program) => {
			(await import("./security-cli-Dtue4pWs.js")).registerSecurityCli(program);
		}
	},
	{
		name: "skills",
		...
		register: async (program) => {
			(await import("./skills-cli-dtS0wXcp.js")).registerSkillsCli(program);
		}
	},
	{
		name: "update",
		...
		register: async (program) => {
			(await import("./update-cli-9sDIiUIm.js")).registerUpdateCli(program);
		}
	},
	{
		name: "completion",
		...
		register: async (program) => {
			(await import("./completion-cli-2ItpXD-U.js").then((n) => n.n)).registerCompletionCli(program);
		}
	}
];
